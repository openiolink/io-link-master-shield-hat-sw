...
{
    //!*************************************************************************
    //! \brief  Construct an PortModeSubject object.
    //!
    //!*************************************************************************
    PortModeSubject::PortModeSubject() : mHandler{nullptr}
    {
    }

    //!*************************************************************************
    //! \brief  Destruct the PortModeSubject object.
    //!
    //!*************************************************************************
    PortModeSubject::~PortModeSubject()
    {
    }
} // namespace openiolink
