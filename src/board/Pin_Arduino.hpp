...
namespace openiolink::arduino
{
    ...
    {
    protected:
        static inline bool init(const int gpioNr, const PinModes mode);
    };
    ...
    //!
    //!*************************************************************************
    inline bool PinBase::init(const int gpioNr, const PinModes mode)
    {
    ...
    //!*************************************************************************
    template <int GpioNr>
    inline bool OutputPin<GpioNr>::init()
    {
        return init(GpioNr, PinModes::out);
    }
    ...
    //!*************************************************************************
    template <int GpioNr>
    inline bool InputPin<GpioNr>::init()
    {
        return init(GpioNr, PinModes::in_pullup);
    }
